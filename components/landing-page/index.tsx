        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#benefits" className="text-slate-300 hover:text-white">Benefits</a>
      ...
      <section className="relative py-32 lg:py-48">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              <Link href="/dashboard">
                <Button size="lg" className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-bold text-lg px-8 py-6">
                  Go to Dashboard
                </Button>
              </Link>
            ) : (
